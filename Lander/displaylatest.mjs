...
//             console.log('Listing element:', listingElement); // Log the created element
...
export async function displayLatestListings() {
    ...
    function displayListings(listings, count) {
        // Remove the Load More button before adding new listings
        if (newListingsDiv.contains(loadMoreButton)) {
            newListingsDiv.removeChild(loadMoreButton);
        }
        ...
        // Append the Load More button after adding new listings
        newListingsDiv.appendChild(loadMoreButton);
    ...
    loadMoreButton.addEventListener('click', () => displayListings(listings, 8));
}
